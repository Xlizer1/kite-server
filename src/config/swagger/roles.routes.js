/**
 * Swagger documentation for roles routes
 */
 ...
 *                 message:
 *                   type: string
 *                   example: You don't have the permission to view roles!
 *       500:
 ...
 *                 message:
 *                   type: string
 *                   example: You don't have the permission to create a role!
 *       500:
 *         description: Server error
 *         content:
 *           application/json:
 ...
 *                 message:
 *                   type: string
 *                   example: You don't have the permission to update a role!
 *       404:
 ...
 *                 message:
 *                   type: string
 *                   example: You don't have the permission to update user permissions!
 *       404:
 ...
 *                 message:
 *                   type: string
 *                   example: Failed to update user permissions.
 *       500:
 *         description: Server error
 *         content:
 *           application/json:
 ...
 *                 message:
 *                   type: string
 *                   example: You don't have the permission to delete a role!
 *       404:
 *         description: Role not found
 *         content:
 *           application/json:
